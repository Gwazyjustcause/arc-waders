...
const WorkshopView = (() => {
  ...
  const renderLevelCard = (station, level) => {
    ...
    header.innerHTML = `
      <span class="station-level-pill">Workshop Station</span>
      <h4 class="station-level-title">${station.name} ${roman || level.label || `Level ${level.level}`}</h4>
    ...
    resourcesSection.innerHTML = '<h5>Required Resources</h5>';
